...
export default function QualityPolicy() {
  ...
  return (
    <section className="w-full bg-white">
      ...
      {/* ✅ Modal Image */}
      {showModal && (
        <div className="fixed inset-0 bg-[#05468D]/70 bg-opacity-70 flex items-center justify-center z-50 p-4">
          <div className="relative max-w-3xl w-full">
            {/* X Button */}
            <button
              onClick={() => setShowModal(false)}
              className="absolute -top-4 -right-4 sm:top-2 sm:right-2 text-white text-6xl font-bold z-50  bg-opacity-50 rounded-full w-10 h-10 flex items-center justify-center"
            >
              &times;
            </button>
